...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Banyaknya bar yang ingin dibuat", font=controller.title_font)
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Jalankan",
                            command=lambda *args: chooseDeg('a'))
        button2 = tk.Button(self, text="Keluar",
